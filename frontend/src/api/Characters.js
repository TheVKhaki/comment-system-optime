...
const Characters = () => {
  return [
    ...
    },
    {
      ...
      abbrPosition: "CMO",
      description:
        "Hans is a visionaire with persistent entrepreneurial spirit. In 2009 he started his career with online poker related affiliate marketing. Due to the burdensome gambling regulation, he ended up settling his company in Malta, which used to have Europe’s friendliest iGaming legislation at the time. Throughout the decade Hans gained comperehensive expertise on iGaming industry, and eventually performed as a marketing strategist and director of product development in Malta’s leading iGaming company.",
    ...
    },
    {
      ...
      abbrPosition: "",
      description:
        "MR is a professional data analyst and blockchain enthusiast. He has all-around understanding over systems security and multi-model databases. In recent years, MR has been working as a senior analyst of data management in major finance and e-commerce businesses.",
      email: "mailto:MR@qpoker.io",
