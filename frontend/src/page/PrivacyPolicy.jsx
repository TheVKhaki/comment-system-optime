    ...
    <Container>
      <div className="privacy-policy">
        ...
        <p>
          ...
          <strong data-entity-type="MessageEntityBold">QPoker Ltd</strong> ("
        ...
        <ul>
          ...
          <li>
            Download and use our mobile application (QPoker), or any other
        ...
        <p>
          ...
          contact us at info@qpoker.io.
        </p>
        <h2 id="h-summary-of-key-points">SUMMARY OF KEY POINTS</h2>
        <p>
        ...
        <p>
          ...
          <strong data-entity-type="MessageEntityBold">QPoker Ltd</strong> and
        ...
        <p>
          ...
          legal reason to do so. Click&nbsp;<a href="#infouse">here</a>&nbsp;to
          learn more.
        </p>
        <p>
          <strong>
        ...
        <p>
          ...
          available{" "}
          <a
            href="https://app.termly.io/notify/8ba7138f-1a91-411d-866a-31e13ba2cfa2"
            target="_blank"
            rel="noreferrer noopener"
          >
            here
        ...
        <p>
          ...
          <strong data-entity-type="MessageEntityBold">QPoker Ltd</strong> does
          with any information we collect? Click&nbsp;<a href="#toc">here</a>
        ...
        <div id="infocollect">
          <h2 id="h-1-what-information-do-we-collect infocollect">
        ...
        <p>
          ...
          stored by __________. You may find their privacy notice link(s) here:
          __________.
        </p>
        <p>
        ...
        <ul>
          <li>
            ...
            device's calendar, camera, bluetooth, microphone, reminders,
        ...
        <p>
          ...
          please contact us at info@qpoker.io.
        </p>
        ...
        <h3 id="h-account-information">Account Information</h3>
        <p>
        ...
        <p>
          You may contact us by email at&nbsp;info@qpoker.io, by visiting{" "}
          <a
            href="https://qpoker.io/contact-us"
            target="_blank"
            rel="noreferrer noopener"
          >
            https://qpoker.io/contact-us
          </a>
        ...
        <p>
          <strong data-entity-type="MessageEntityBold">QPoker Ltd</strong> has
          ...
          <strong data-entity-type="MessageEntityBold">QPoker Ltd</strong> will
        ...
        <p>
          ...
          at info@qpoker.io&nbsp;or by post to:
        </p>
        <p>
          <strong data-entity-type="MessageEntityBold">QPoker Ltd</strong>
          <br />
